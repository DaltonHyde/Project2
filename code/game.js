...
var buzzSpeed = 1;
var buzzDist = 1.7;
Buggy.prototype.act = function(step) {
  this.wobble += step * buzzSpeed;
  var buzzPos = Math.sin(this.wobble) * buzzDist;
  this.pos = this.basePos.plus(new Vector(0, buzzPos));
};
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  {
    this.player.pos = new Vector(2,22);
  }
};
